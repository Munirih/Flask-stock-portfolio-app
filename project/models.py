...
class User(database.Model):
    ...
    def __init__(self, email: str, password_plaintext: str, email_confirmation_sent_on=None):
        ...
        self.password_hashed = bcrypt.generate_password_hash(
            password_plaintext, current_app.config.get('BCRYPT_LOG_POUNDS')).decode('utf-8')
